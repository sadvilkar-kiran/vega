...
func doMake(arg2, arg3 string) error {
	...
	case "migration":
		...
		upFile := v.RootPath + "/migrations/" + fileName + "." + dbType + ".up.sql"
		downFile := v.RootPath + "/migrations/" + fileName + "." + dbType + ".down.sql"
	...
	case "handler":
		...
		fileName := v.RootPath + "/handlers/" + strings.ToLower(arg3) + ".go"
	...
	case "model":
		...
		fileName := v.RootPath + "/data/" + strings.ToLower(modelName) + ".go"
		if fileExists(fileName) {
			exitGracefully(errors.New(fileName + " already exists!"))
		}
	...
	case "mail":
		...
		htmlMail := v.RootPath + "/mail/" + strings.ToLower(arg3) + ".html.tmpl"
		plainMail := v.RootPath + "/mail/" + strings.ToLower(arg3) + ".plain.tmpl"
